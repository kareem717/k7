...
func getK7Version() string {
	noVersionAvailable := "No version info available for this build, run 'k7 help version' for additional info"
...
the revision hash will be used instead.
	...
	Run: func(cmd *cobra.Command, args []string) {
		version := getK7Version()
		fmt.Printf("K7 CLI version: %v\n", version)
	},
}
